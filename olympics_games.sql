SELECT
 ...
 --       ,CHARINDEX(' ', REVERSE(Games))-1 AS 'Example 2'
        ,LEFT(Games, 4) AS 'Year' -- Split column to isolate Year, based on space
 --       ,RIGHT(Games,6) AS 'Season' -- Split column to isolate Season, based on space
--        ,[Games]
--        ,[City] -- Commented out as it is not necessary for the analysis
  ...
  WHERE RIGHT(Games,6) = 'Summer' -- Where Clause to isolate Summer Season